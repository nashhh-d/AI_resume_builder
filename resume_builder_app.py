...
BACKEND_URL = "https://demiurgic-carlene-unwithdrawing.ngrok-free.dev/generate"   # ← update when backend is live
...
if generate:
    ...
    latex_b64 = result.get("download_latex", "")
    ...
    with dl3:
        if latex_b64:
            latex_bytes = base64.b64decode(latex_b64)
            st.download_button(
            ...
            st.info("LaTeX PDF not available in response.")
